    ...
    <div class="h-full form-control ">
      ...
      <div class="  flex flex-col justify-between">
        ...
        <div class="flex-1 justify-center pr-3 ">
          ...
          <select className=" text-slate-200 select min-w-min max-w-xs">
        ...
        <div class="flex-1 justify-center">
          ...
          <input
            ...
            className="text-slate-200  input w-full max-w-lg"
          />
        </div>
      </div>
      <div class=" h-full min-w-full border-solid">
        <label class="label">
          <h4 class="text-slate-600 font-semibold">Paste Expected Response</h4>
        </label>
        <textarea
          class="h-96 textarea-lg w-full max-w-lg text-slate-200 textarea"
